// 한글 욕설 출처 : PersesTitan's BadWordFiltering
// https://github.com/PersesTitan/BadWordFiltering
...
export const wordsToCensor = [ "ㅅㅂ", "씨발", "씨바", "개세끼", "18년", "18놈", "18새끼", "ㄱㅐㅅㅐㄲl", "ㄱㅐㅈㅏ", "가슴만져", "가슴빨아", "가슴빨어", "가슴조물락", "가슴주물럭", "가슴쪼물딱",
    ...
    "좃만아", "좃만이", "좃만한것", "좃만한쉐이", "좃물", "좃물냄새", "좃보지", "좃부랄", "좃빠구리", "좃빠네", "좃빠라라", "좃털", "좇","좆같은놈", "좆같은새끼", "좆까", "좆까라",
